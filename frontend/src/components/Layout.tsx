...
import { Sparkles, LogIn, Twitter, Github, Disc as Discord } from 'lucide-react';
...
const Layout: React.FC = () => {
  ...
  const navLinkClasses = (path: string) => `
    ...
    ${isActiveRoute(path) ? 'after:content-[""] after:absolute after:-bottom-1 after:left-0 after:w-full after:h-0.5 after:bg-pink/40 after:rounded-full' : ''}
  `;
            ...
            <nav className="hidden md:block mr-8">
              <ul className="flex items-center space-x-8">
                ...
                <li>
                  <Link 
                    to="/spinner" 
                    className={navLinkClasses('/spinner')}
                  >
                    Spinner
                  </Link>
                </li>
